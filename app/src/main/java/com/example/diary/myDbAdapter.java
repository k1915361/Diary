...
public class myDbAdapter {
    ...
    public String getData() {
        ...
        String[] columns = {myDbHelper.ID,myDbHelper.NAME, myDbHelper.MyPLATFORM};

        Cursor cursor = db.query(myDbHelper.TABLE_NAME, columns, null, null,null,null,null);
        StringBuffer buffer = new StringBuffer();
        while(cursor.moveToNext())
        {
            int cid = cursor.getInt(cursor.getColumnIndexOrThrow(myDbHelper.ID));
    ...
    static class myDbHelper extends SQLiteOpenHelper {
        ...
        private static final String CREATE_TABLE = "CREATE TABLE "+TABLE_NAME+
                " ("+ID+" INTEGER PRIMARY KEY AUTOINCREMENT, "+NAME+" VARCHAR(255) ,"+ MyPLATFORM+" VARCHAR(225));";
